...
function renderDetails(){
  ...
  document.getElementById("compositionDetail").innerHTML = detailCompareList(composition,compBase,state.compIndex,["peso","grasaPct","grasaKg","magra","pliegues","cintura","abdomen"],compDates,labels.composition,"comp");
